...
GIT_BRANCH = "2.2" #@param {type:"string"}
...
"""
    cell1 = new_code_cell(cell1_code, metadata={"title": "1. 設定並同步專案程式碼"})
...
"""
    cell2 = new_code_cell(cell2_code, metadata={"title": "2. 安裝 Python 相依套件"})
...
"""
    cell3 = new_code_cell(cell3_code, metadata={"title": "3. 【一鍵執行】啟動主流程"})
